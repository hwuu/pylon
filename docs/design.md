...
- [4. 限流策略](#4-限流策略)
  - [4.1 限流维度](#41-限流维度)
  - [4.2 限流检查顺序](#42-限流检查顺序)
  - [4.3 请求队列](#43-请求队列)
  - [4.4 API 识别](#44-api-识别)
  - [4.5 SSE 特殊处理](#45-sse-特殊处理)
  - [4.6 SSE 错误处理](#46-sse-错误处理)
  - [4.7 配置示例](#47-配置示例)
  - [4.8 限流实现](#48-限流实现)
- [5. API Key 认证](#5-api-key-认证)
  - [5.1 传递方式](#51-传递方式)
  - [5.2 验证流程](#52-验证流程)
  - [5.3 API Key 格式](#53-api-key-格式)
- [6. 管理界面认证](#6-管理界面认证)
  - [6.1 认证方式](#61-认证方式)
  - [6.2 生成密码哈希](#62-生成密码哈希)
  - [6.3 登录流程](#63-登录流程)
  - [6.4 未来扩展](#64-未来扩展)
- [7. 管理界面功能](#7-管理界面功能)
  - [7.1 功能列表](#71-功能列表)
...
- [11. 测试策略](#11-测试策略)
  - [11.1 单元测试](#111-单元测试)
  - [11.2 端到端测试](#112-端到端测试)
- [12. 未来扩展方向](#12-未来扩展方向)
  - [12.1 Redis 支持](#121-redis-支持)
  - [12.2 更多限流维度](#122-更多限流维度)
  - [12.3 更多认证方式](#123-更多认证方式)
- [13. 开发计划](#13-开发计划)
...
│   ├── services/
│   │   ├── __init__.py
│   │   ├── auth.py             # API Key 认证服务
│   │   ├── admin_auth.py       # 管理员认证服务
